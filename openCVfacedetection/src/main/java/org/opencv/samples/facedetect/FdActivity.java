...
public class FdActivity extends Activity implements CvCameraViewListener2 {
    ...
    public double CmpPic(String file1, String file2) {
        ...
        opencv_core.IplImage Image1 = cvLoadImage(Environment.getExternalStorageDirectory() + "/" + file1 + ".jpg", CV_LOAD_IMAGE_GRAYSCALE);
        opencv_core.IplImage Image2 = cvLoadImage(Environment.getExternalStorageDirectory() + "/" + file2 + ".jpg", CV_LOAD_IMAGE_GRAYSCALE);
